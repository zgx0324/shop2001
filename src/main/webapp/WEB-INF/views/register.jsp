...
<title>注册</title>
<link rel="stylesheet" type="text/css" href="http://localhost:8080/shop2001/css/style.css" />
<link rel="stylesheet" type="text/css" href="http://localhost:8080/shop2001/css/shopping-mall-index.css" />
<script type="text/javascript" src="http://localhost:8080/shop2001/js/jquery.js"></script>
<script type="text/javascript" src="http://localhost:8080/shop2001/js/zhonglin.js"></script>
<script type="text/javascript" src="http://localhost:8080/shop2001/js/zhongling2.js"></script>
<script>
    $(function () {
        //1.校验用户名是否重复
        $("#userName").change(function () {
            ...
            if(userName.trim()!=""){
                ...
                $.ajax({
                    ...
                    url:"http://localhost:8080/shop2001/user/checkUserName.do",
        ...
        $("#passWord").change(function () {
            ...
            //正则表达式 密码由6-16的字母a-zA-Z、数字\d、符号组成\W
        ...
        $("#changePic").click(function () {
            $("#validateImg").attr("src","${pageContext.request.contextPath}/validate/getValidateImg.do?msg="+Math.random())
        })

        //5.校验图形验证码
        $("#validateCode").change(function () {
            var validateCode = $(this).val()
            //由于session在jsp中一旦渲染该jsp成功，那么在jsp中session就不会更新了。
            //为了解决这一问题，只能用ajax的方式在后台校验验证码，返回结果给当前这个方法
            $.ajax({
                ...
                success:function (data) {
                    if(data=="yes"){
                        ...
                        $("#validateMsg").text("验证码输入成功")
                    }else{
                        $("#validateMsg").attr("class","cuo")
                        $("#validateMsg").text("验证码输入错误")
                    }
                }
            })
        })
...
<body>
    ...
    <div class="logo-search w1200">
    	<div class="logo-box f-l">
        	<div class="logo f-l">
            	<a href="index.html" title="中林logo"><img src="http://localhost:8080/shop2001/images/zl2-01.gif" /></a>
            </div>
        	...
        	<div class="sl-city-top">
                ...
                <a class="close-select-city f-r" href="JavaScript:;">
                	<img src="http://localhost:8080/shop2001/images/close-select-city.gif" />
                </a>
            </div>
        ...
        <div class="erweima f-r">
        	<a href="JavaScript:;"><img src="http://localhost:8080/shop2001/images/zl2-04.gif" /></a>
        </div>
    ...
    <!--内容开始-->
    <form action="http://localhost:8080/shop2001/user/doRegister.do" method="post" onsubmit="return sub()">
        <div class="password-con registered">
            <div class="psw">
                <p class="psw-p1">用户名</p>
                <input type="text" name="userName" id="userName" placeholder="HR了" required/>
            ...
            <div class="psw">
                ...
                <input type="text" placeholder="请再次确认密码" required/>
            </div>
            <div class="psw">
                <p class="psw-p1">手机号/邮箱</p>
                <input type="text" id="phone" name="phone" placeholder="请输入手机/邮箱验证码" required/>
                <span id="phoneMsg" name="msg"></span>
            </div>
            <div class="psw psw3">
                <p class="psw-p1">验证码</p>
                <input type="text" id="validateCode" placeholder="请输入验证码" required/>
                <span id="validateMsg" name="msg"></span>
            </div>
            <div class="yanzhentu">
                <div class="yz-tu f-l">
                    <img id="validateImg" src="${pageContext.request.contextPath}/validate/getValidateImg.do" />
                </div>
    ...
    <div class="footer-box">
    	<ul class="footer-info1 w1200">
        	<li>
            	<div class="ft-tu1">
                	<a href="JavaScript:;"><img src="http://localhost:8080/shop2001/images/zl2-86.gif" /></a>
                </div>
        	...
        	<li>
            	<div class="ft-tu1">
                	<a href="JavaScript:;"><img src="http://localhost:8080/shop2001/images/zl2-87.gif" /></a>
                </div>
        	...
        	<li>
            	<div class="ft-tu1">
                	<a href="JavaScript:;"><img src="http://localhost:8080/shop2001/images/zl2-88.gif" /></a>
                </div>
        	...
        	<li>
            	<div class="ft-tu1">
                	<a href="JavaScript:;"><img src="http://localhost:8080/shop2001/images/zl2-89.gif" /></a>
                </div>
        	...
        	<li>
            	<div class="ft-tu1">
                	<a href="JavaScript:;"><img src="http://localhost:8080/shop2001/images/zl2-90.gif" /></a>
                </div>
        ...
        <div class="footer-info3 w1200">
            ...
            <div class="ft-if3-tu1">
            	<a href="#"><img src="http://localhost:8080/shop2001/images/zl2-91.gif" /></a>
            	<a href="#"><img src="http://localhost:8080/shop2001/images/zl2-92.gif" /></a>
            	<a href="#"><img src="http://localhost:8080/shop2001/images/zl2-93.gif" /></a>
            </div>
        </div>
    </div>
