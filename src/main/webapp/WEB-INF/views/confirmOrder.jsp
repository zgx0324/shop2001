        ...
        <div class="payment-interface w1200">
            <div class="pay-info">
                ...
                <table>
                    ...
                    <tr>
                        <td>收货地址：</td>
                        <td><input type="text" name="addr" value="${user.addr}" required/></td>
                    </tr>
                    <tr>
                        <td>联系方式</td>
            ...
            <div class="cart-con-info">
                ...
                <c:forEach items="${cart.cartItems}" var="cartItem">
                    <div class="info-mid">
                        ...
                        <div class="mid-font f-l" style="width:232px;margin-right:40px;">
                        ...
                        <div class="mid-sl f-l" style="width:71px;margin:10px 54px 0px 0px;margin-left: 50px">
                                ${cartItem.count}
                        </div>
