...
<body style="position:relative;">
    ...
    <div class="payment w1200">
        ...
        <div class="payment-bd">
            <c:forEach items="${orderExt.orderItemExts}" var="orderItemExts">
                <dl class="dl-hd">
                    <dt><a href="#"><img style="width: 123px;height: 122px" src="${pageContext.request.contextPath}/${orderItemExts.product.image}" /></a></dt>
                    <dd>
                        <h3><a href="#">${orderItemExts.product.pName}</a></h3>
                        <P>${fn:substring(orderItemExts.product.pDesc,0 ,30 )}...</P>
                        <p>数量：${orderItemExts.count}</p>
                        <p>单价：<span style="color: red">￥${orderItemExts.product.shopPrice}</span></p>
                        <p>共计：<span style="color: red">￥${orderItemExts.subTotal}</span></p>
                    </dd>
                    <div style="clear:both;"></div>
                </dl>
            </c:forEach>
            ...
            <ul class="ul-bd">
            	...
            	<li><span>卖家名称</span><p>爱尚微购专营店</p></li>
